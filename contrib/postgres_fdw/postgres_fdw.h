...
typedef struct PgFdwConnState
{
	...
	PgFdwScanState *active_scan;	/* the streaming_fetch scan, if any, that
									 * currently has an unconsumed result */
} PgFdwConnState;
...
extern void drain_other_active_scan(PgFdwConnState *conn_state);
...
extern PGresult *pgfdw_exec_query(PGconn *conn, const char *query,
								  PgFdwConnState *state);
extern bool pgfdw_cancel_query(PGconn *conn, PgFdwConnState *state);
