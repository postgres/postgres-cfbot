...
multirangejoinsel(PG_FUNCTION_ARGS)
{
	...
	/*
	 * Can't use the histograms with insecure range support functions.  See
	 * the equivalent check in rangejoinsel(): both the range comparison
	 * function and the subtype difference function may be applied to bounds
	 * taken from either side's histogram.
	 */
