...
pgstat_relation_flush_cb(PgStat_EntryRef *entry_ref, bool nowait)
{
	...
	tabentry->numscans += lstats->tab.counts.nontxn.numscans;
	if (lstats->tab.counts.nontxn.numscans)
	{
	...
	tabentry->tuples_returned += lstats->tab.counts.nontxn.tuples_returned;
	tabentry->tuples_fetched += lstats->tab.counts.nontxn.tuples_fetched;
	tabentry->tuples_inserted += lstats->tab.counts.txn.tuples_inserted;
	tabentry->tuples_updated += lstats->tab.counts.txn.tuples_updated;
	tabentry->tuples_deleted += lstats->tab.counts.txn.tuples_deleted;
	tabentry->tuples_hot_updated += lstats->tab.counts.txn.tuples_hot_updated;
	tabentry->tuples_newpage_updated += lstats->tab.counts.txn.tuples_newpage_updated;

	/*
	 * If table was truncated/dropped, first reset the live/dead counters.
	 */
	if (lstats->tab.counts.txn.truncdropped)
	{
	...
	tabentry->live_tuples += lstats->tab.counts.txn.delta_live_tuples;
	tabentry->dead_tuples += lstats->tab.counts.txn.delta_dead_tuples;
	tabentry->mod_since_analyze += lstats->tab.counts.txn.changed_tuples;
	 ...
	 */
	tabentry->ins_since_vacuum += lstats->tab.counts.txn.tuples_inserted;

	tabentry->blocks_fetched += lstats->tab.counts.nontxn.blocks_fetched;
	tabentry->blocks_hit += lstats->tab.counts.nontxn.blocks_hit;
	...
	dbentry->tuples_returned += lstats->tab.counts.nontxn.tuples_returned;
	dbentry->tuples_fetched += lstats->tab.counts.nontxn.tuples_fetched;
	dbentry->tuples_inserted += lstats->tab.counts.txn.tuples_inserted;
	dbentry->tuples_updated += lstats->tab.counts.txn.tuples_updated;
	dbentry->tuples_deleted += lstats->tab.counts.txn.tuples_deleted;
	dbentry->blocks_fetched += lstats->tab.counts.nontxn.blocks_fetched;
	dbentry->blocks_hit += lstats->tab.counts.nontxn.blocks_hit;
