...
%token <keyword> ABORT_P ABSENT ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	ESCAPE EVENT EXCEPT EXCLUDE EXCLUDING EXCLUSIVE EXECUTE EXISTING EXISTS EXPLAIN
	...
	REFRESH REINDEX RELATIVE_P RELEASE REMOVE RENAME REPACK REPEATABLE REPLACE REPLICA
