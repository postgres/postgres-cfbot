...
transformRangeGraphTable(ParseState *pstate, RangeGraphTable *rgt)
{
	...
	/*
	 * The syntax does not allow nested GRAPH_TABLE, and subqueries within a
	 * GRAPH_TABLE are prohibited (see transformSubLink), so there should be
	 * only one GRAPH_TABLE being transformed at a time.
	 */
