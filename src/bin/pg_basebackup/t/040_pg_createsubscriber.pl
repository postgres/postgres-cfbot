...
# Run pg_createsubscriber with '--all'. Specify --verbose twice to enable
# debug-level messages, which are required to record the generated
# CREATE PUBLICATION command in the internal log file checked below.
