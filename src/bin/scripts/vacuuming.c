					...
					const char *progname)
{
	...
	/*
	 * With --continue, a database we cannot connect to is not a fatal
	 ...
	 * on to the next one.  The option is rejected unless --all was given, so
	 * this cannot quietly skip a database named on the command line.
	 */
