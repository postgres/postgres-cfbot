...
extern void pgstat_count_io_op_time_ext(IOObject io_object, IOContext io_context,
										IOOp io_op, instr_time start_time,
...
/* used by pgstat_io.c for I/O times tracked per tablespace */
extern void pgstat_count_tablespace_io_op_time(Oid spcoid, IOOp io_op,
											   instr_time io_time);
