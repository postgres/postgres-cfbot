...
extern instr_time pgstat_count_io_op_time(IOObject io_object, IOContext io_context,
...
extern void pgstat_create_tablespace(Oid spcoid);
...
extern void pgstat_count_tablespace_blk_read_time(Oid spcoid, instr_time io_time);
extern void pgstat_count_tablespace_blk_write_time(Oid spcoid, instr_time io_time);
