 ...
 */
CATALOG(pg_temp_statistic_ext_data,8089,TempStatisticExtDataRelationId) BKI_TEMP_RELATION
{
...
DECLARE_TOAST(pg_temp_statistic_ext_data, 8090, 8091);

DECLARE_UNIQUE_INDEX_PKEY(pg_temp_statistic_ext_data_stxoid_inh_index, 8092, TempStatisticExtDataStxoidInhIndexId, pg_temp_statistic_ext_data, btree(stxoid oid_ops, stxdinherit bool_ops));
