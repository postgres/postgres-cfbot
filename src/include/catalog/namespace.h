...
extern bool TypeIsTrustedInExtensionScript(Oid typid);
extern int	errdetail_untrusted_relation(const RangeVar *relation);
extern int	errdetail_untrusted_type(const char *schemaname,
									 const char *typname);
