...
CREATE TABLE pht3_p1 PARTITION OF pht3 FOR VALUES WITH (MODULUS 2, REMAINDER 0);
CREATE TABLE pht3_p2 PARTITION OF pht3 FOR VALUES WITH (MODULUS 2, REMAINDER 1);
INSERT INTO pht3 SELECT i, to_char(i/50, 'FM0000'), i % 10 FROM generate_series(0, 599, 2) i;
ANALYZE pht3;

CREATE TABLE pht4 (a int, c varchar(40), d int) PARTITION BY HASH (c, d);
CREATE TABLE pht4_p1 PARTITION OF pht4 FOR VALUES WITH (MODULUS 2, REMAINDER 0);
CREATE TABLE pht4_p2 PARTITION OF pht4 FOR VALUES WITH (MODULUS 2, REMAINDER 1);
INSERT INTO pht4 SELECT i, to_char(i/50, 'FM0000'), i % 10 FROM generate_series(0, 599, 3) i;
ANALYZE pht4;
...
EXPLAIN (COSTS OFF)
SELECT t1.a, t2.a FROM pht3 t1 JOIN pht4 t2 ON t1.d = t2.d WHERE t1.c = '0002' AND t2.c = '0002';
SELECT count(*) FROM pht3 t1 JOIN pht4 t2 ON t1.d = t2.d WHERE t1.c = '0002' AND t2.c = '0002';
RESET enable_hashjoin;
...
CREATE TABLE pht5_p1 PARTITION OF pht5 FOR VALUES WITH (MODULUS 2, REMAINDER 0);
CREATE TABLE pht5_p2 PARTITION OF pht5 FOR VALUES WITH (MODULUS 2, REMAINDER 1);
INSERT INTO pht5 SELECT i, to_char(i/50, 'FM0000') FROM generate_series(0, 599, 2) i;
...
CREATE TABLE pht6_p1 PARTITION OF pht6 FOR VALUES WITH (MODULUS 2, REMAINDER 0);
CREATE TABLE pht6_p2 PARTITION OF pht6 FOR VALUES WITH (MODULUS 2, REMAINDER 1);
INSERT INTO pht6 SELECT i, to_char(i/50, 'FM0000') FROM generate_series(0, 599, 3) i;
ANALYZE pht6;

CREATE TABLE pht7 (a int, c varchar(40)) PARTITION BY HASH ((c::text));
CREATE TABLE pht7_p1 PARTITION OF pht7 FOR VALUES WITH (MODULUS 2, REMAINDER 0);
CREATE TABLE pht7_p2 PARTITION OF pht7 FOR VALUES WITH (MODULUS 2, REMAINDER 1);
INSERT INTO pht7 SELECT i, to_char(i/50, 'FM0000') FROM generate_series(0, 599, 5) i;
ANALYZE pht7;
...
EXPLAIN (COSTS OFF)
SELECT count(*), count(t2.a) FROM pht5 t1 LEFT JOIN pht6 t2 ON t1.c::text = t2.c::text;
SELECT count(*), count(t2.a) FROM pht5 t1 LEFT JOIN pht6 t2 ON t1.c::text = t2.c::text;
