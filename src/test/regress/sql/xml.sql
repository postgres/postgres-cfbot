...
-- attribute name matching a namespace prefix is valid (different namespaces)
SELECT xmlelement(NAME "root", xmlnamespaces('http:/x.y/ns1' AS ns1), xmlattributes('val' AS ns1));
