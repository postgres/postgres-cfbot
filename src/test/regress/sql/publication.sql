...
-- Check that the sequence description shows the publications where it is named
-- in an EXCEPT clause
\d+ regress_seq0
...
DROP SEQUENCE regress_seq0, pub_test.regress_seq1, pub_test.regress_seq2, regress_seq_unlogged;
