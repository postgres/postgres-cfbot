...
\d gtest25
ALTER TABLE gtest25
  ADD COLUMN z INT DEFAULT 11,
  ADD CONSTRAINT cc CHECK(b > 9) NOT VALID,
  ADD CONSTRAINT check_z CHECK(z > 9) NOT VALID;

ALTER TABLE gtest25
    ALTER COLUMN z SET DATA TYPE numeric,
    ALTER COLUMN b SET EXPRESSION AS (z + 1); -- ok

ALTER TABLE gtest25
    ALTER COLUMN b SET DATA TYPE numeric,
    ALTER COLUMN b SET EXPRESSION AS (z + 2); -- ok
SELECT * FROM gtest25 ORDER BY a;
\d gtest25
