...
SELECT src, dst, el1, el2 FROM GRAPH_TABLE (g1 MATCH (a IS vl1)-[e1 IS el1]->{,2}(c IS vl3)-[e2]->(d IS vl3) COLUMNS (a.vname AS src, d.vname AS dst, e1.ename AS el1, e2.ename AS el2)) ORDER BY src, dst, el1, el2 COLLATE "C";
